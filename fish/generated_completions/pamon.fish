# pamon
# Autogenerated from man page /bedrock/cross/man/man1/pamon.1
...
complete -c pamon -l process-time-msec -d 'Explicitly configure the process time, with a time specified in miliseconds'
