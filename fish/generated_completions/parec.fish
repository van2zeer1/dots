# parec
# Autogenerated from man page /bedrock/cross/man/man1/parec.1
...
complete -c parec -l process-time-msec -d 'Explicitly configure the process time, with a time specified in miliseconds'
