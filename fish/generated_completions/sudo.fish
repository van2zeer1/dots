# sudo
# Autogenerated from man page /bedrock/cross/man/man8/sudo.8
...
complete -c sudo -s V -d 'Print the sudo version string as well as the version string of the security p…'
