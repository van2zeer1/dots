# loginctl
# Autogenerated from man page /bedrock/cross/man/man1/loginctl.1
...
complete -c loginctl -s i -l ignore-inhibitors -d 'When system shutdown or a sleep state is requested, ignore inhibitor locks'
...
complete -c loginctl -l firmware-setup -d 'is given, indicate to the systems firmware to reboot into the firmware setup …'
