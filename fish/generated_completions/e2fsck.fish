# e2fsck
# Autogenerated from man page /bedrock/cross/man/man8/e2fsck.8
...
complete -c e2fsck -s D -d 'Optimize directories in filesystem'
complete -c e2fsck -s E -d 'Set e2fsck extended options'
complete -c e2fsck -s f -d 'are run'
complete -c e2fsck -s F -d 'Flush the filesystem device\'s buffer caches before beginning'
complete -c e2fsck -s j -d 'Set the pathname where the external-journal for this filesystem can be found'
...
complete -c e2fsck -s n -d 'Open the filesystem read-only, and assume an answer of `no\' to all questions'
