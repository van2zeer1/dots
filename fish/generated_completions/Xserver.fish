# Xserver
# Autogenerated from man page /bedrock/cross/man/man1/Xserver.1
...
complete -c Xserver -o fc -d 'sets default cursor font'
complete -c Xserver -o fn -d 'sets the default font'
...
complete -c Xserver -o to -d 'sets default connection timeout in seconds'
...
complete -c Xserver -o wm -d 'forces the default backing-store of all windows to be WhenMapped'
