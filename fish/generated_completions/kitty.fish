# kitty
# Autogenerated from man page /bedrock/cross/man/man1/kitty.1
...
complete -c kitty -l title -s T -d 'Set the window title'
...
complete -c kitty -l directory -s d -d 'Change to the specified directory when launching Default: '
...
complete -c kitty -l debug-keyboard -d 'This option will cause kitty to print out key events as they are received'
complete -c kitty -l debug-font-fallback -d 'Print out information about the selection of fallback fonts for characters no…'
complete -c kitty -l debug-config -d 'Print out information about the system and kitty configuration'
