# pacat
# Autogenerated from man page /bedrock/cross/man/man1/pacat.1
...
complete -c pacat -l process-time-msec -d 'Explicitly configure the process time, with a time specified in miliseconds'
