# grub-mknetdir
# Autogenerated from man page /bedrock/cross/man/man1/grub-mknetdir.1
complete -c grub-mknetdir -l compress -d 'compress GRUB files [optional]'
complete -c grub-mknetdir -l dtb -d 'embed a specific DTB'
complete -c grub-mknetdir -s d -l directory -d 'use images and modules under DIR [default=/usr/lib64/grub/<platform>]'
