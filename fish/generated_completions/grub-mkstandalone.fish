# grub-mkstandalone
# Autogenerated from man page /bedrock/cross/man/man1/grub-mkstandalone.1
...
complete -c grub-mkstandalone -s d -l directory -d 'use images and modules under DIR [default=/usr/lib64/grub/<platform>]'
