# git-read-tree
# Autogenerated from man page /bedrock/cross/man/man1/git-read-tree.1
...
complete -c git-read-tree -l exclude-per-directory -d 'When running the command with -u and -m options, the merge result may need to…'
