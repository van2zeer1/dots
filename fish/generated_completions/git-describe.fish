# git-describe
# Autogenerated from man page /bedrock/cross/man/man1/git-describe.1
...
complete -c git-describe -l abbrev -d 'Instead of using the default 7 hexadecimal digits as the abbreviated object n…'
