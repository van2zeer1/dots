# git-shortlog
# Autogenerated from man page /bedrock/cross/man/man1/git-shortlog.1
...
complete -c git-shortlog -l first-parent -d 'Follow only the first parent commit upon seeing a merge commit'
