# git-branch
# Autogenerated from man page /bedrock/cross/man/man1/git-branch.1
...
complete -c git-branch -s f -l force -d 'Reset <branchname> to <startpoint>, even if <branchname> exists already'
complete -c git-branch -s m -l move -d 'Move/rename a branch and the corresponding reflog'
complete -c git-branch -s M -d 'Shortcut for --move --force'
complete -c git-branch -s c -l copy -d 'Copy a branch and the corresponding reflog'
