# git-show
# Autogenerated from man page /bedrock/cross/man/man1/git-show.1
...
complete -c git-show -l encoding -d 'The commit objects record the encoding used for the log message in their enco…'
