# grub-mkrescue
# Autogenerated from man page /bedrock/cross/man/man1/grub-mkrescue.1
complete -c grub-mkrescue -l compress -d 'compress GRUB files [optional]'
complete -c grub-mkrescue -l dtb -d 'embed a specific DTB'
complete -c grub-mkrescue -s d -l directory -d 'use images and modules under DIR [default=/usr/lib64/grub/<platform>]'
