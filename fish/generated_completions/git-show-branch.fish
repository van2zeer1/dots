# git-show-branch
# Autogenerated from man page /bedrock/cross/man/man1/git-show-branch.1
...
complete -c git-show-branch -l independent -d 'Among the <reference>s given, display only the ones that cannot be reached fr…'
