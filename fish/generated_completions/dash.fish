# dash
# Autogenerated from man page /bedrock/cross/man/man1/dash.1
...
complete -c dash -s p -d 'search for command using a PATH that guarantees to find all the standard util…'
