# git-config
# Autogenerated from man page /bedrock/cross/man/man1/git-config.1
...
complete -c git-config -s f -l file -d 'Use the given config file instead of the one specified by GIT_CONFIG'
...
complete -c git-config -l ignore-revs-file -d 'blame. markUnblamables'
...
complete -c git-config -l preserve-merges -d 'along to git rebase so that locally committed merge commits will not be flatt…'
...
complete -c git-config -l negotiation-tip -d 'option for git-fetch(1).  fetch. showForcedUpdates'
