# git-worktree
# Autogenerated from man page /bedrock/cross/man/man1/git-worktree.1
complete -c git-worktree -s f -l force -d 'By default, add refuses to create a new working tree when <commit-ish> is a b…'
complete -c git-worktree -s b -s B -d 'With add, create a new branch named <new-branch> starting at <commit-ish>, an…'
complete -c git-worktree -s d -l detach -d 'With add, detach HEAD in the new working tree'
...
complete -c git-worktree -l lock -d 'Keep the working tree locked after creation'
...
complete -c git-worktree -l expire -d 'With prune, only expire unused working trees older than <time>'
complete -c git-worktree -l reason -d 'With lock, an explanation why the working tree is locked'
