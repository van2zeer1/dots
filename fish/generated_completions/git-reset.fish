# git-reset
# Autogenerated from man page /bedrock/cross/man/man1/git-reset.1
complete -c git-reset -s q -l quiet -l no-quiet -d 'Be quiet, only report errors.  The default behavior is set by the reset'
