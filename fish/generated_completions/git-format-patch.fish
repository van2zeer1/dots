# git-format-patch
# Autogenerated from man page /bedrock/cross/man/man1/git-format-patch.1
...
complete -c git-format-patch -o 'l<num>' -d 'The -M and -C options require O(n^2) processing time where n is the number of…'
