# git-apply
# Autogenerated from man page /bedrock/cross/man/man1/git-apply.1
...
complete -c git-apply -s 3 -l 3way -d 'When the patch does not apply cleanly, fall back on 3-way merge if the patch …'
