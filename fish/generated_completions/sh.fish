# sh
# Autogenerated from man page /bedrock/cross/man/man1/sh.1
...
complete -c sh -s p -d 'search for command using a PATH that guarantees to find all the standard util…'
