# nvim
# Autogenerated from man page /bedrock/cross/man/man1/nvim.1
...
complete -c nvim -s d -d 'Diff mode.  Show the difference between two to four files, similar to sdiff 1'
complete -c nvim -s R -d 'Read-only mode.  Sets the \'readonly\' option.  Implies n'
complete -c nvim -s Z -d 'Restricted mode.  Disable commands that make use of an external shell'
...
complete -c nvim -s l -d 'Lisp mode.  Sets the \'lisp\' and \'showmatch\' options'
...
complete -c nvim -s D -d 'Debug mode for VimL (Vim script)'
...
complete -c nvim -s i -d 'Use shada instead of the default ~/. local/share/nvim/shada/main. shada'
complete -c nvim -l noplugin -d 'Skip loading plugins.  Implied by -u NONE'
complete -c nvim -l clean -d 'Skip loading plugins and shada (viminfo) file'
...
complete -c nvim -s S -d 'Source session after the first file argument has been read'
