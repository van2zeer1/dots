# git
# Autogenerated from man page /bedrock/cross/man/man1/git.1
complete -c git -l version -d 'Prints the Git suite version that the git program came from'
complete -c git -l help -d 'Prints the synopsis and a list of the most commonly used commands'
...
complete -c git -l super-prefix -d 'Currently for internal use only'
