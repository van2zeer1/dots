# git-name-rev
# Autogenerated from man page /bedrock/cross/man/man1/git-name-rev.1
...
complete -c git-name-rev -l stdin -d 'Transform stdin by substituting all the 40-character SHA-1 hexes (say $hex) w…'
