# newusers
# Autogenerated from man page /bedrock/cross/man/man8/newusers.8
complete -c newusers -l badname -d 'Allow names that do not conform to standards'
complete -c newusers -s c -l crypt-method -d 'Use the specified method to encrypt the passwords'
...
complete -c newusers -s s -l sha-rounds -d 'Use the specified number of rounds to encrypt the passwords'
