# file
# Autogenerated from man page /bedrock/cross/man/man1/file.1
...
complete -c file -s h -d 'option causes symlinks not to be followed (on systems that support symbolic l…'
...
complete -c file -s L -d 'option causes symlinks to be followed, as the like-named option in ls 1 (on s…'
