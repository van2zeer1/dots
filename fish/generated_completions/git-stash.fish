# git-stash
# Autogenerated from man page /bedrock/cross/man/man1/git-stash.1
complete -c git-stash -s a -l all -d 'This option is only valid for push and save commands'
complete -c git-stash -s u -l include-untracked -d 'This option is only valid for push and save commands'
