# mke2fs
# Autogenerated from man page /bedrock/cross/man/man8/mke2fs.8
...
complete -c mke2fs -s C -d 'Specify the size of cluster in bytes for filesystems using the bigalloc featu…'
complete -c mke2fs -s d -d 'Copy the contents of the given directory into the root directory of the files…'
...
complete -c mke2fs -s E -d 'Set extended options for the filesystem'
complete -c mke2fs -s F -d 'Force  mke2fs to create a filesystem, even if the specified device is not a p…'
...
complete -c mke2fs -s j -d 'Create the filesystem with an ext3 journal'
...
complete -c mke2fs -s L -d 'Set the volume label for the filesystem to R new-volume-label '
complete -c mke2fs -s m -d 'Specify the percentage of the filesystem blocks reserved for the super-user'
complete -c mke2fs -s M -d 'Set the last mounted directory for the filesystem'
complete -c mke2fs -s n -d 'Causes  mke2fs to not actually create a filesystem, but display what it would…'
...
complete -c mke2fs -s r -d 'Set the filesystem revision for the new filesystem.   Note that 1'
...
complete -c mke2fs -s T -d 'Specify how the filesystem is going to be used, so that  mke2fs can choose op…'
complete -c mke2fs -s U -d 'Set the universally unique identifier (UUID) of the filesystem to R UUID '
