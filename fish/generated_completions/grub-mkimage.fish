# grub-mkimage
# Autogenerated from man page /bedrock/cross/man/man1/grub-mkimage.1
...
complete -c grub-mkimage -s d -l directory -d 'use images and modules under DIR [default=/usr/lib64/grub/<platform>]'
