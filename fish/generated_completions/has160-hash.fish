# has160-hash
# Autogenerated from man page /bedrock/cross/man/man1/has160-hash.1
...
complete -c has160-hash -l no-detect-by-ext -d 'Disable hash function detection from a hash file extension in the --check mode'
...
complete -c has160-hash -l base64 -d 'Print message digests in Base64 format'
