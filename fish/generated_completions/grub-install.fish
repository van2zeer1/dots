# grub-install
# Autogenerated from man page /bedrock/cross/man/man8/grub-install.8
complete -c grub-install -l compress -d 'compress GRUB files [optional]'
complete -c grub-install -l dtb -d 'embed a specific DTB'
complete -c grub-install -s d -l directory -d 'use images and modules under DIR [default=/usr/lib64/grub/<platform>]'
