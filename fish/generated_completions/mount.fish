# mount
# Autogenerated from man page /bedrock/cross/man/man8/mount.8
complete -c mount -l target -d or
complete -c mount -l source -d 'options to avoid ambiguous interpretation of the given argument'
complete -c mount -l fstab -d 'command-line option (see below for more details)'
complete -c mount -s F -d 'option will make mount fork, so that the filesystems are mounted in parallel'
complete -c mount -l options-mode -d 'command-line option'
complete -c mount -l options-source-force -d 'to always read configuration from fstab '
...
complete -c mount -s N -l namespace -d 'Perform the mount operation in the mount namespace specified by ns'
...
complete -c mount -l target-prefix -d 'Prepend the specified directory to all mount targets'
...
complete -c mount -l rw -l read-write -d 'Mount the filesystem read/write'
