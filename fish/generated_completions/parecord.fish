# parecord
# Autogenerated from man page /bedrock/cross/man/man1/parecord.1
...
complete -c parecord -l process-time-msec -d 'Explicitly configure the process time, with a time specified in miliseconds'
