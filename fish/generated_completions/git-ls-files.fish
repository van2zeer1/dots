# git-ls-files
# Autogenerated from man page /bedrock/cross/man/man1/git-ls-files.1
complete -c git-ls-files -s c -l cached -d 'Show cached files in the output (default)'
complete -c git-ls-files -s d -l deleted -d 'Show deleted files in the output'
complete -c git-ls-files -s m -l modified -d 'Show modified files in the output'
...
complete -c git-ls-files -s u -l unmerged -d 'Show unmerged files in the output (forces --stage)'
complete -c git-ls-files -s k -l killed -d 'Show files on the filesystem that need to be removed due to file/directory co…'
