# git-rebase
# Autogenerated from man page /bedrock/cross/man/man1/git-rebase.1
...
complete -c git-rebase -s m -l merge -d 'Use merging strategies to rebase'
complete -c git-rebase -s s -l strategy -d 'Use the given merge strategy'
...
complete -c git-rebase -s p -l preserve-merges -d '[DEPRECATED: use --rebase-merges instead] Recreate merge commits instead of f…'
...
complete -c git-rebase -l fixup/--squash -d 'options of git-commit(1)'
complete -c git-rebase -s C -d 'are incompatible with the following options: oc o 2. 3'
complete -c git-rebase -l patience -d 'diff-algorithm=[patience|minimal|histogram|myers]'
complete -c git-rebase -l diff-algorithm -d 'ignore-space-change, ignore-all-space, ignore-space-at-eol, ignore-cr-at-eol'
...
complete -c git-rebase -l no-renames -d 'find-renames[=<n>]'
