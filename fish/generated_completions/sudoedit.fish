# sudoedit
# Autogenerated from man page /bedrock/cross/man/man8/sudoedit.8
...
complete -c sudoedit -s V -d 'Print the sudoedit version string as well as the version string of the securi…'
