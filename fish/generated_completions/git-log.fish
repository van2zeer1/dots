# git-log
# Autogenerated from man page /bedrock/cross/man/man1/git-log.1
...
complete -c git-log -l decorate-refs -l decorate-refs-exclude -d 'If no --decorate-refs is given, pretend as if all refs were included'
...
complete -c git-log -l first-parent -d 'Follow only the first parent commit upon seeing a merge commit'
...
complete -c git-log -l encoding -d 'The commit objects record the encoding used for the log message in their enco…'
