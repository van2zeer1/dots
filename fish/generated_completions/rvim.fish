# rvim
# Autogenerated from man page /bedrock/cross/man/man1/rvim.1
...
complete -c rvim -s d -d 'Start in diff mode.  There should be two, three or four file name arguments'
