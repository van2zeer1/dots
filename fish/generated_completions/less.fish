# less
# Autogenerated from man page /bedrock/cross/man/man1/less.1
...
complete -c less -o Dxcolor -l color -d '[MS-DOS only] Sets the color of the text displayed'
...
complete -c less -o kfilename -l lesskey-file -d 'Causes  less to open and interpret the named file as a R lesskey (1) file'
