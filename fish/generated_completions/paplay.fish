# paplay
# Autogenerated from man page /bedrock/cross/man/man1/paplay.1
...
complete -c paplay -l process-time-msec -d 'Explicitly configure the process time, with a time specified in miliseconds'
