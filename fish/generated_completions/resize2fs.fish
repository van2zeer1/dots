# resize2fs
# Autogenerated from man page /bedrock/cross/man/man8/resize2fs.8
...
complete -c resize2fs -s f -d 'Forces resize2fs to proceed with the filesystem resize operation, overriding …'
complete -c resize2fs -s F -d 'Flush the filesystem device\'s buffer caches before beginning'
complete -c resize2fs -s M -d 'Shrink the file system to minimize its size as much as possible, given the fi…'
complete -c resize2fs -s p -d 'Prints out a percentage completion bars for each  resize2fs operation during …'
