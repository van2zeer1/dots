# ethtool
# Autogenerated from man page /bedrock/cross/man/man8/ethtool.8
...
complete -c ethtool -s S -l statistics -d 'Queries the specified network device for NIC- and driver-specific statistics'
