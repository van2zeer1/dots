# ed2k-link
# Autogenerated from man page /bedrock/cross/man/man1/ed2k-link.1
...
complete -c ed2k-link -l no-detect-by-ext -d 'Disable hash function detection from a hash file extension in the --check mode'
...
complete -c ed2k-link -l base64 -d 'Print message digests in Base64 format'
