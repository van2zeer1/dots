# git-fetch
# Autogenerated from man page /bedrock/cross/man/man1/git-fetch.1
...
complete -c git-fetch -l recurse-submodules -d 'This option controls if and under what conditions new commits of populated su…'
